...
See more properties and methods in `app` under [Photoshop](../ps-reference/classes/photoshop.md).
...
As you may notice, this restriction could encompass much of your plugin's functionality! There are many benefits for this model, however. A more detailed explanation is provided in the [Execute as Modal documentation](../ps-reference/media/executeasmodal.md).
...
See more properties and methods regarding `Document` under [Document](../ps-reference/classes/document.md) and [Documents](../ps-reference/classes/documents.md).
...
See more properties and methods for `Layer` under [Layer](../ps-reference/classes/layer.md) and [Layers](../ps-reference/classes/layers.md).
...
See more properties and methods for `Action` under [Action](../ps-reference/classes/action.md) and [ActionSet](../ps-reference/classes/actionset.md)
...
UXP is not just for plugins anymore.  Individual JavaScript files may be developed and executed as detailed in the [UXP Scripting section](../ps-reference/media/uxpscripting.md).