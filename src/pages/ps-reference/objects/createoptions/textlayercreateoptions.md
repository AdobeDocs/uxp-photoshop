...
and passed to [Document.createTextLayer](/ps-reference/classes/document.md#createtextlayer).
...
| :------ | :------ | :------ | :------ | :------ |
| blendMode | [*BlendMode*](/ps-reference/modules/constants.md#blendmode) | NORMAL | 22.5 | Blend mode of the newly created layer or group. |
| color | [*LabelColors*](/ps-reference/modules/constants.md#labelcolors) | NONE | 22.5 | Label color of the newly created layer or group. |
...
| ~~mode~~ | [*BlendMode*](/ps-reference/modules/constants.md#blendmode) | NORMAL | 22.5 | Deprecated, please use &#x60;blendMode&#x60; above as it will override this value. |
...
| position | [*Position*](/ps-reference/objects/options/position.md) | document center | 24.2 | Insertion coordinates of the newly created text layer, in pixels |
| textColor | [*SolidColor*](/ps-reference/classes/solidcolor.md) | black | 24.2 | Text color of the newly created text layer. |
