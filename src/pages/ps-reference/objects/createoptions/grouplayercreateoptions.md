...
and passed to [Document.createLayerGroup](/ps-reference/classes/document.md#createlayergroup).
...
| fromLayers | [*Layer*](/ps-reference/classes/layer.md) \| [*Layer*](/ps-reference/classes/layer.md)[] | - | 22.5 | Layer(s) to populate the newly created group. |
