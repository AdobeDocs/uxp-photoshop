...
keywords:
  ...
  - C++
  - Scripting
description: An object literal can be constructed with any of the following properties and passed to Document.createLayer.
---

# PixelLayerCreateOptions

An object literal can be constructed with any of the following properties and passed to [Document.createLayer](/ps-reference/classes/document.md#createlayer).
