...
| descriptor | *object* | 22.5 | An object literal that is passed as the second parameter of &#x60;targetFunction&#x60; following an [executeAsModal](../../media/executeasmodal.md) call. Cannot include functions. |
| interactive | *boolean* | 23.3 | Optional mode where UI interactions are permissible within the executeAsModal state. Useful for allowing users to input data into invoked dialogs or workspaces. See [Modal Execution](../../media/executeasmodal.md). |
