...
keywords:
  ...
  - C++
  - Scripting
description: Represents a single history state in the History panel.
---
...
| parent | [*Document*](/ps-reference/classes/document.md) | R | 22.5 | Owner document of this history state. |
