...
keywords:
  ...
  - C++
  - Scripting
description: The Class that stores properties related to the Character panel in the Photoshop UI.
---
...
| antiAliasMethod | [*AntiAlias*](/ps-reference/modules/constants.md#antialias) | R W | SHARP | - | 24.1 | The text anti-aliasing |
| autoKerning | [*AutoKernType*](/ps-reference/modules/constants.md#autokerntype) | R W | METRICS | - | 24.1 | The auto kerning option to use. |
| baseline | [*Baseline*](/ps-reference/modules/constants.md#baseline) | R W | NORMAL | - | 24.1 | The text baseline. |
| baselineShift | *number* | R W | - | -1296..1296 | 24.1 | The value in pixels to use in the baseline offset of text for a 72ppi document. |
| capitalization | [*TextCase*](/ps-reference/modules/constants.md#textcase) | R W | NORMAL | - | 24.1 | The text case. |
| characterAlignment | [*CharacterAlignment*](/ps-reference/modules/constants.md#characteralignment) | R W | ROMAN | - | 24.1 | Character alignment. When a line of text contains different sizes of characters, you can specify how to align text to the largest characters in the line. |
| color | [*SolidColor*](/ps-reference/classes/solidcolor.md) | R W | - | - | 24.1 | The text color as a [SolidColor](/ps-reference/classes/solidcolor.md) instance. |
...
| font | *string* | R W | - | - | 24.1 | The text face of the character, using the PostScript name of the font. See [TextFont](/ps-reference/classes/textfont.md) and use the &#x60;postScriptName&#x60; property. |
...
| language | [*Language*](/ps-reference/modules/constants.md#language) | R W | - | - | 24.1 | Language used as a basis for hyphenation rules and spelling. |
...
| middleEasternDigitsType | [*MiddleEasternDigitsType*](/ps-reference/modules/constants.md#middleeasterndigitstype) | R W | LTRARABIC | - | 24.1 | The text digits type to use (Middle Eastern features) |
| middleEasternTextDirection | [*MiddleEasternTextDirection*](/ps-reference/modules/constants.md#middleeasterntextdirection) | R W | DEFAULT | - | 24.1 | The text direction (Middle Eastern features) |
...
| strikeThrough | [*StrikeThrough*](/ps-reference/modules/constants.md#strikethrough) | R W | STRIKEOFF | - | 24.1 | Whether the text is strikethrough or not. |
...
| underline | [*Underline*](/ps-reference/modules/constants.md#underline) | R W | NONE | - | 24.1 | The underline style to use. |
