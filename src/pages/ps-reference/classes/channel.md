...
keywords:
  ...
  - C++
  - Scripting
description: Represents a channel in a Photoshop document.
---
...
| :------ | :------ | :------ | :------ | :------ |
| color | [*SolidColor*](/ps-reference/classes/solidcolor.md) | R W | 23.0 | The color of the channel. |
...
| kind | [*ChannelType*](/ps-reference/modules/constants.md#channeltype) | R W | 23.0 | The type or kind of the channel. |
...
| parent | [*Document*](/ps-reference/classes/document.md) | R | 23.0 | The containing document. |
...
| :------ | :------ | :------ |
| `targetDocument?` | [*Document*](/ps-reference/classes/document.md) | if specified, duplicate to a different document target. |
