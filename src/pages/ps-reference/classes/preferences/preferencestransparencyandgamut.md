...
keywords:
  ...
  - C++
  - Scripting
description: Preferences how transparency will be shown and what color to use for out of gamut warning
---
...
| gridSize | [*GridSize*](/ps-reference/modules/constants.md#gridsize) | R W | 24.0 | The size of grid squares used to construct the transparency pattern |
