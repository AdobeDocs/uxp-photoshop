...
keywords:
  ...
  - C++
  - Scripting
description: All preferences related to history logging
---
...
| editLogItems | [*EditLogItemsType*](/ps-reference/modules/constants.md#editlogitemstype) | R W | 24.0 | Options for edit log items.  Sets &#x60;history.useHistoryLog &#x3D; true&#x60; as side effect. |
...
| saveLogItems | [*SaveLogItemsType*](/ps-reference/modules/constants.md#savelogitemstype) | R W | 24.0 | Options for saving the history items. It can be metadata, file or both.  Sets &#x60;history.useHistoryLog &#x3D; true&#x60; as side effect. |
