...
keywords:
  ...
  - C++
  - Scripting
description: Preferences how guides, grids and slices will be shown
---
...
| :------ | :------ | :------ | :------ | :------ |
| gridStyle | [*GridLineStyle*](/ps-reference/modules/constants.md#gridlinestyle) | R W | 24.0 | The formatting style for non-printing grid lines |
| gridSubDivisions | *number* | R W | 24.0 | The whole number by which to subdivide the grid [1,100]. |
| guideStyle | [*GuideLineStyle*](/ps-reference/modules/constants.md#guidelinestyle) | R W | 24.0 | The formatting style for non-printing guide lines. |
