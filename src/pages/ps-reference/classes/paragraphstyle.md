...
| :------ | :------ | :------ | :------ | :------ | :------ | :------ |
| features | [*TypeInterfaceFeatures*](/ps-reference/modules/constants.md#typeinterfacefeatures) | R W | [DEFAULT](Constants.TypeInterfaceFeatures) | - | 24.1 | The paragraph UI features to display. |
...
| justification | [*Justification*](/ps-reference/modules/constants.md#justification) | R W | [LEFT](Constants.Justification) | - | 24.1 | The paragraph justification. |
...
| kashidaWidth | [*KashidaWidthType*](/ps-reference/modules/constants.md#kashidawidthtype) | R W | [MEDIUM](Constants.KashidaWidthType) | - | 24.1 | The width of kashida (tatweel) character |
| kinsoku | [*Kinsoku*](/ps-reference/modules/constants.md#kinsoku) | R W | [NONE](Constants.Kinsoku) | - | 24.1 | Line breaking rules in Japanese text (Kinsoku Shori) |
| layoutMode | [*ParagraphLayout*](/ps-reference/modules/constants.md#paragraphlayout) | R W | [WORLD](Constants.ParagraphLayout) | - | 24.1 | The paragraph layout mode. |
| leftIndent | *number* | R W | - | -1296..1296 | 24.1 | The amount of space in pixels to indent text from the left for a 72ppi document. |
| mojikumi | [*Mojikumi*](/ps-reference/modules/constants.md#mojikumi) | R W | [NONE](Constants.Mojikumi) | - | 24.1 | Spacing between punctuation, symbols, numbers, and other character classes in Japanese text. |
