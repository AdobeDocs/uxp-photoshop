...
keywords:
  ...
  - C++
  - Scripting
description: Represents a single guide in the document.
---
...
| direction | [*Direction*](/ps-reference/modules/constants.md#direction) | R W | 23.0 | Indicates whether the guide is vertical or horizontal. |
...
| parent | [*Document*](/ps-reference/classes/document.md) | R | 23.0 | Owner document of this guide. |
