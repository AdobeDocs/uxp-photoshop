...
- [Constants.layerKind](../../ps-reference/modules/constants.md#layerkind) now includes entries for the new Adjustment layers, Grain and Clarity.
...
- Noted that [`imaging.encodeImageData()`](../../ps-reference/media/imaging.md#encodeimagedata) expects RGB image data.
...
- `updateUI` If you are looking to refresh the Layers panel while dragging a slider handle, try [`updateUI()`](../../ps-reference/classes/photoshop.md#updateui).
- [`core.convertGlobalToLocal()`](../../ps-reference/media/photoshopcore.md#convertglobaltolocal) can be used to convert a global coordinate point to one based on a panel's reference point.
...
See Advanced > [Action Recording](../../ps-reference/media/action-recording.md) for usage details.

### batchPlay option: suppressProgressBar
This [value](../../ps-reference/media/batchplay.md#command-execution-options) can be used to suppress a Photoshop progress bar while the command is being executed.

### Selection
In [Document.selection](../../ps-reference/classes/document.md#selection) you can now find the new [Selection](../../ps-reference/classes/selection.md) class for handling pixel selection.
...
### Imaging API update
The [Imaging API](../../ps-reference/media/imaging.md) is moving out of Prerelease.  It will now be available in the Beta build with the module name "imaging".
...
### Imaging API Beta
We are excited to provide an entirely new capability with the [Imaging API](../../ps-reference/media/imaging.md).  Anyone that has been eagerly awaiting the ability to directly get and set pixels in a document should head to the [dedicated page](../../ps-reference/media/imaging.md).  Note: we are serious about the Beta label.  While this is exciting new territory, keep in mind that the API is in an early form.  We want your feedback to help guide it toward maturity.
...
- A [Document.createTextLayer](../../ps-reference/classes/document.md#createtextlayer) method was added, which allows developers to create a new text layer in a document. It accepts a [TextLayerCreateOptions](../../ps-reference/objects/createoptions/textlayercreateoptions.md) object, which can be used to set the initial text content, style, and other properties.
...
- The [CountItems collection](../../ps-reference/classes/countitems.md) behaves like other collections at the Document level in the API. CountItems further support the following properties and methods:
...
- Passing a value that is not in [Constants.blendMode](../../ps-reference/modules/constants.md#blendmode).
...
- The [CountItem class](../../ps-reference/classes/countitem.md) implements the following properties and methods: 
...
### Preferences
Adds API to change some of the Photoshop [preferences](../../ps-reference/classes/preferences.md). Only first set of 38 preferences was added. More will follow.

### ColorSamplers support
The ColorSampler DOM API is now available in Photoshop.

- The [ColorSamplers collection](../../ps-reference/classes/colorsamplers.md) behaves like other collections at the Document level in the API. ColorSamplers further supports the following methods:
    - `colorSamplers.add()` 
    - `colorSamplers.removeAll()`
- The [ColorSamplers class](../../ps-reference/classes/colorsampler.md) implements the following properties and methods: 
    - `typename`: String
    - `parent`: [Document](../../ps-reference/classes/document.md)
...
### Layer Comps support
- [Document.layerComps](../../ps-reference/classes/document.md#layercomps) property is now added, giving access to similar APIs from ExtendScript to work with layer comps.
- [LayerComps collection](../../ps-reference/classes/layercomps.md)
  - Adds the following Layer Comp methods: `add()`, `removeAll()`, `getByName()`
  - Create new layer comps in the document using [`LayerComps.add()`](../../ps-reference/classes/layercomps.md#add) method. Constructors for them can be found in [app](../../ps-reference/classes/photoshop.md) object.
- [LayerComp class](../../ps-reference/classes/layercomp.md)
...
### Guide fixes
- [Guide.coordinate](../../ps-reference/classes/guide.md#coordinate) Fixes coordinate getter when document resolution is not 72 PPI
- [Guide.coordinate](../../ps-reference/classes/guide.md#coordinate) Fixes coordinate setter when document resolution is not 72 PPI
- [Guides.add](../../ps-reference/classes/guides.md#add) Fixes coordinate when creating a new guide if document resolution is not 72 PPI
- [Guides.add](../../ps-reference/classes/guides.md#add) Creating a new guide had returned an invalid, nonexistent instance. It now points to an existing guide.

### Known Issues and Workarounds
- A new page of [Known Issues and Workarounds](../../ps-reference/known-issues/index.md) was introduced, and aims to outline some common issues encountered by our developer community. New entries will be summarized in this changelog.
- A note about increased error throws from `batchPlay`, specifically with the `move` command, was added.

### Layer Filter Methods
- [Layer.applySmartBlur(radius: number, threshold: number, blurQuality: Constants.SmartBlurQuality, mode: Constants.SmartBlurMode)](../../ps-reference/classes/layer.md#applysmartblur) Applies the smart blur filter.
- [Layer.applySpherize(amount: number, mode: Constants.SpherizeMode)](../../ps-reference/classes/layer.md#applyspherize) Applies the spherize filter.
- [Layer.applyUnSharpMask(amount: number, radius: number, threshold: number)](../../ps-reference/classes/layer.md#applyunsharpmask) Applies the unsharp mask filter.
- [Layer.applyWave(generatorNumber: number, minimumWavelength: number, maximumWavelength: number, minimumAmplitude: number, maximumAmplitude: number, horizontalScale: number, verticalScale: number, waveType: Constants.WaveType, undefinedAreas: Constants.UndefinedAreas, randomSeed: number)](../../ps-reference/classes/layer.md#applywave) Applies the wave filter.
- [Layer.applyZigZag(amount: number, ridges: number, style: Constants.ZigZagType)](../../ps-reference/classes/layer.md#applyzigzag) Applies the zigzag filter.
...
- [Ps UXP Scripting](../../ps-reference/media/uxpscripting.md)

### Layer Filter methods
- [Layer.applyAddNoise(amount: number, distribution: Constants.NoiseDistribution, monochromatic: boolean)](../../ps-reference/classes/layer.md#applyaddnoise) Applies the Add Noise filter.
- [Layer.applyAverage()](../../ps-reference/classes/layer.md#applyaverage) Applies the Average filter.
...
- [Layer.applyDiffuseGlow(graininess: number, glowAmount: number, clearAmount: number)](../../ps-reference/classes/layer.md#applydiffuseglow) Applies the Diffuse Glow filter.
- [Layer.applyDisplace(horizontalScale: number, verticalScale: number, displacementType: Constants.DisplacementMapType, undefinedAreas: Constants.UndefinedAreas, displacementMapFile: File)](../../ps-reference/classes/layer.md#applydisplace) Applies the Displace filter.
- [Layer.applyDustAndScratches(radius: number, threshold: number)](../../ps-reference/classes/layer.md#applydustandscratches) Applies the Dust and Scratches filter.
- [Layer.applyGaussianBlur(radius: number)](../../ps-reference/classes/layer.md#applygaussianblur) Applies the Gaussian Blur filter.
...
- [Layer.applyMotionBlur(angle: number, distance: number)](../../ps-reference/classes/layer.md#applymotionblur) Applies the Motion Blur filter.
- [Layer.applyNTSC()](../../ps-reference/classes/layer.md#applyntsc) Applies the NTSC filter.
- [Layer.applyOceanRipple(size: number, magnitude: number)](../../ps-reference/classes/layer.md#applyoceanripple) Applies the Ocean Ripple filter.
- [Layer.applyOffset(horizontal: number, vertical: number, undefinedAreas: Constants.OffsetUndefinedAreas)](../../ps-reference/classes/layer.md#applyoffset) Applies the Offset filter.
- [Layer.applyTwirl(angle: number)](../../ps-reference/classes/layer.md#applytwirl) Applies the Twirl filter.
- [Layer.applyPinch(amount: number)](../../ps-reference/classes/layer.md#applypinch) Applies the Pinch filter.
- [Layer.applyPolarCoordinates(conversion: Constants.PolarConversionType)](../../ps-reference/classes/layer.md#applypolarcoordinates) Applies the Polar Coordinates filter.
- [Layer.applyRipple(amount: number, size: Constants.RippleSize)](../../ps-reference/classes/layer.md#applyripple) Applies the Ripple filter.
...
### Paths support
 ...
 - `Document.pathItems` provides the collection class [PathItems](../../ps-reference/classes/pathitems.md), which is a collection of [PathItem](../../ps-reference/classes/pathitem.md) objects.
 - `PathItem.subPathItems` provides the collection class [SubPathItems](../../ps-reference/classes/subpathitems.md), which is a collection of [SubPathItem](../../ps-reference/classes/subpathitem.md) objects.
 - `SubPathItem.pathPoints` provides the collection class [PathPoints](../../ps-reference/classes/pathpoints.md), which is a collection of [PathPoint](../../ps-reference/classes/pathpoint.md) objects.
 - Create new paths in the document using [`PathItems.add`](../../ps-reference/classes/pathitems.md#add) method by providing `PathPointInfo` and `SubPathInfo` objects. Constructors for them can be found in [app](../../ps-reference/classes/photoshop.md) object.

### Load on Launch support
You can now set your plugin manifest to load your plugin on app launch. See [Photoshop Manifest](../../guides/uxp-guide/uxp-misc/manifest-v4/photoshop-manifest/index.md) for details.

### batchPlay development helper: Copy as Javascript
It is now possible to use the Photoshop Actions panel to help build your plugin. Record valid actions, and let Photoshop generate readable and valid batchPlay to use in your UXP plugin. See the [batchPlay documentation](../../ps-reference/media/batchplay.md#accepted-action-descriptors) under "Accepted action descriptors".

### Core event: "userIdle"
This event is generated when Photoshop detects that a user becomes idle, while Photoshop is the foreground application. A plugin must specify a number of idle seconds, and then may choose to batch process-intensive tasks. See [photoshopCore](../../ps-reference/media/photoshopcore.md).
...
### Channel support
- [Channels collections](../../ps-reference/classes/channels.md) behave like other collections in the API. Channels further supports `channels.add()` and `channels.removeAll()`. 
- [Channel class](../../ps-reference/classes/channel.md)
    - Supports four types of channels, as listed in [Constants.ChannelType](../../ps-reference/modules/constants.md#channeltype): `COMPONENT`, `MASKEDAREA`, `SELECTEDAREA`, `SPOTCOLOR`.
...
### [SolidColor](../../ps-reference/classes/solidcolor.md) API
...
### [Document.suspendHistory](../../ps-reference/classes/document.md#suspendhistory)
...
### [Layer Move APIs](../../ps-reference/classes/layer.md#move)
...
- [HistoryStates collections](../../ps-reference/classes/historystates.md) and [HistoryState API](../../ps-reference/classes/historystate.md)
...
- [Documents collections](../../ps-reference/classes/documents.md)
    - Documents also follows ExtendScript functionality. `length`, `add`, `getByName(name)`, `parent` are provided.
- [Constants module](../../ps-reference/modules/constants.md), collecting all enumerations and constants used in DOM API. Accessible via `require("photoshop").constants`.
- Updated [app.createDocument / app.add](../../ps-reference/classes/photoshop.md#createdocument)
...
- [Execute as Modal](../../ps-reference/media/executeasmodal.md) allows you to create plugins that can be guaranteed exclusive control over Photoshop during execution. It further allows for clear user feedback when this is occuring, and allows plugins to `suspendHistory` and `resumeHistory`.