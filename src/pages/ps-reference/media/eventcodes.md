...
- [`action.addNotificationListener`](../../ps-reference/media/photoshopaction.md#addnotificationlistener) is used with Photoshop events that alter a document.
- [`core.addNotificationListener`](../../ps-reference/media/photoshopcore.md#addnotificationlistener) is used with other events including those involving the UI and coming from the operating system.


### Action Events
The first table contains action events, the four-character ID codes used in ExtendScript, and the string event used with [`action.addNotificationListener`](../../ps-reference/media/photoshopaction.md#addnotificationlistener). 
...
### Core Events
See [`core.addNotificationListener`](../../ps-reference/media/photoshopcore.md#addnotificationlistener).
