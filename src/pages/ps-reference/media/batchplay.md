...
This command modifies the Photoshop state and must therefore be executed from within a modal scope. See the documentation of [executeAsModal](../../ps-reference/media/executeasmodal.md) for details. The following JavaScript uses batchPlay to hide the active layer:
```javascript
...
This option is deprecated as of Photoshop 2022. New JavaScript code should use the history suspension mechanism provided by [executeAsModal](../../ps-reference/media/executeasmodal.md#history-state-suspension)
