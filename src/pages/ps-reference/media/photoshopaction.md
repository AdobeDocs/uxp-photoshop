...
```
A [table of events is available](../../ps-reference/media/eventcodes.md#action-events) or
the [introspection methods described under `batchPlay`](../../ps-reference/media/batchplay.md) may be employed.
