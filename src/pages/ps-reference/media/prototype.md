...
We build the DOM APIs with a lot of intent and care to work around expectations Photoshop may have when a command is being [batchPlayed](../../ps-reference/media/batchplay.md). 
