...
In order to properly interpret pixel data, Photoshop needs to know which color profile the data is expressed in. An example of a color profile is `"Adobe RGB (1998)"`. Photoshop will perform color conversions when needed. You can get the list of available color profiles by invoking [getColorProfiles](../../ps-reference/classes/photoshop.md#getcolorprofiles) on the app object:
```javascript
