...
Prepare your hybrid plugin to be listed in the Creative Cloud Marketplace via [Developer Distribution](https://developer.adobe.com/developer-distribution/creative-cloud/docs/guides/getting_started/) by following the [general packaging guidelines](../../distribution/packaging-your-plugin/index.md).
...
4. Ensure the plugin works on all three architectures - Mac M1, Mac Intel, and Windows Intel. Find some tips in this [guide](../faqs/index.md#how-can-i-prepare-the-binaries).
