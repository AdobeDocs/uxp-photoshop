...
description: As of this writing, the only other Creative Cloud application that supports UXP is Adobe XD. Here are the main differences between UXP in Photoshop and UXP
---
...
So if you have an XD plugin that you are porting to Photoshop, make sure to look at the current structure of the [manifest.json](/guides/uxp-guide/uxp-misc/manifest-v4/index.md) file.
...
As of this writing, the [Photoshop API](/ps-reference/index.md) is less mature than what's available in XD, but this is changing rapidly with each Photoshop release. Until the Photoshop API surface is complete for every object of interest, you can use an interface called [batchPlay](/ps-reference/media/batchplay.md) to get to objects, properties, and actions that are not yet exposed to UXP directly.