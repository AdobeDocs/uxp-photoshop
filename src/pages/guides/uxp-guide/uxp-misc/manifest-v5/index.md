...
Starting from changes to top-level metadata, here are some keys that changed with the v5 upgrade. Read [manifest v4](../../../uxp-guide/uxp-misc/manifest-v4/index.md) to learn more about each key/value field.
...
![Webview](../../../uxp-guide/uxp-misc/manifest-v5/webview-example.png)
