...
ExtendScript developers wishing to migrate their plugins onto the UXP platform should consult the [UXP for ExtendScript Developers](.././uxp-for-you/uxp-for-extendscript-devs/index.md).
...
CEP developers wishing to migrate their plugins onto the UXP platform should consult the [UXP for CEP Developers](.././uxp-for-you/uxp-for-cep-devs/index.md).
...
A communication bridge suite was created to allow C++ plugins running under Photoshop to communicate with UXP plugins. See [Communication with C++ Plugin SDK](../../ps-reference/media/cpp-pluginsdk.md).
